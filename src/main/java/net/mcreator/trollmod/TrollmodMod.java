...
@Mod("trollmod")
public class TrollmodMod {
	public static final Logger LOGGER = LogManager.getLogger(TrollmodMod.class);
	public static final String MODID = "trollmod";
